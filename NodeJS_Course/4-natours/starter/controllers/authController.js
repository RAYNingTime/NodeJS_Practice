...
exports.restrictTo =
  ...
  (req, res, next) => {
    ...
    if (!roles.includes(req.user.role)) {
      return next(
        new AppError('You do not have permission to perform this actuin.', 403)
      );
    }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot your password? Submit a PATC request with new password and passwordConfirm to ${resetURL}.\nIf you didn't forget your password, please ignore this email!`;
